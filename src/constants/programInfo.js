...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its full-time bootcamp to provide students with a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
